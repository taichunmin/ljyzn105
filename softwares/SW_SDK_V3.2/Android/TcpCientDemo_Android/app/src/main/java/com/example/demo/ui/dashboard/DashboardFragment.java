    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btnReadRF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(netapi.NetApiReadDeviceOneParam((byte)0xFF,bParamAddr,bValue) == true) {
        ...
        btnSetRF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(netapi.NetApiSetDeviceOneParam((byte)0xFF,bParamAddr,bValue) == true) {
                    mShow.setText("Success");
                }
                else mShow.setText("Failed");
            }
        ...
        btnReadFreq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(netapi.NetApiReadFreq((byte)0xFF,pFreq) == true) {
                    //pFreq[0]   pFreq[1]
                    //0x31        0x80     //US Freq
                    //0x4E        0x00     //Europe
                    //0x2C        0xA3     //China
        ...
        btnSetFreq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(netapi.NetApiSetFreq((byte)0xFF,pFreq) == true) {
                    mShow.setText("Success");
                }
                else mShow.setText("Failed");
            }
