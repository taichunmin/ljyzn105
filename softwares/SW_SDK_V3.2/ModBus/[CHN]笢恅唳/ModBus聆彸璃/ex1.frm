...
If Index > 0 And Index < 256 Then statusline = "从设备异常响应"
If Index = 256 Then statusline = "无效的句柄"
If Index = 257 Then statusline = "Modbus 消息溢出"
If Index = 258 Then statusline = "无效的地址"
If Index = 259 Then statusline = "无效的设备地址"
If Index = 260 Then statusline = "无效的长度规格"
If Index = 261 Then statusline = "无效的 modbus 命令"
If Index = 262 Then statusline = "驱动 内存溢出"
If Index = 263 Then statusline = "* * 超时 * *"
If Index = 264 Then statusline = "无效的协议规范"
If Index = 265 Then statusline = "* * 错误的校验和 * *"
If Index = 266 Then statusline = "服务器未连接"
If Index = 267 Then statusline = "从驱动程序响应无效"
If Index = 268 Then statusline = "Modbus 写入失败"
If Index = 269 Then statusline = "远程服务器未连接"
If Index = 270 Then statusline = "* * 未初始化 * *"
If Index = 271 Then statusline = "ModScan 演示时间过期"
