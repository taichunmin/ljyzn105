	...
	public MainDlg() {
		...
		ActionListener taskPerformer = new ActionListener() {
		      public void actionPerformed(ActionEvent evt) {
		            ...
		            bRet = RFID.instance.SWHid_GetTagBuf(arrBuffer, iTotalLen, iNum);
		            //if (bRet == 1)
		            //{
		            //	ShowInfo("DevOut");
		            //    return; //DevOut
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {  //Open
				if(RFID.instance.SWHid_GetUsbCount() > 0)
				{
					if(RFID.instance.SWHid_OpenDevice(0))
					{
						ShowInfo("Success\r\n");
					    byte[] arrBuffer = new byte[48];
					    byte addr = (byte)0xff;
					    if(RFID.instance.SWHid_GetDeviceSystemInfo(addr, arrBuffer))  //Get DeviceInfo
					    {
				            String str = "",str1="";
							...
							timer.start();
							RFID.instance.SWHid_ClearTagBuf();
					    }
		...
		btnClose.addActionListener(new ActionListener() {  //Close
			public void actionPerformed(ActionEvent arg0) {
				timer.stop();
				RFID.instance.SWHid_CloseDevice();
				btnNewButton.setEnabled(true);
				btnClose.setEnabled(false);
			}
		});
		...
		btnRead.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            if (RFID.instance.SWHid_ReadDeviceOneParam((byte)0xFF, bParamAddr, bValue) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnSet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	            ...
	            if (RFID.instance.SWHid_SetDeviceOneParam((byte)0xFF, bParamAddr, bValue[0]) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnRead_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            if (RFID.instance.SWHid_ReadFreq((byte)0xFF, pFreq) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnSet_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            if (RFID.instance.SWHid_SetFreq((byte)0xFF, pFreq) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnRead_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	            if (RFID.instance.SWHid_StartRead((byte)0xFF) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnSet_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            if (RFID.instance.SWHid_StopRead((byte)0xFF) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
