...
public class MainDlg extends JFrame {
	...
	public MainDlg() {
		...
		btnNewButton.setBounds(10, 52, 88, 40);
		...
		btnClose.setBounds(108, 52, 94, 40);
		...
		comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"COM1", "COM2", "COM3", "COM4", "COM5", "COM6", "COM7", "COM8", "COM9", "COM10"}));
		comboBox_2.setSelectedIndex(0);
		comboBox_2.setBounds(106, 11, 73, 21);
		contentPane.add(comboBox_2);
		
		JLabel lblCom = new JLabel("Com");
		lblCom.setBounds(25, 14, 71, 15);
		...
		ActionListener taskPerformer = new ActionListener() {
		      public void actionPerformed(ActionEvent evt) {
		            ...
		            bRet = RFID.instance.SWCom_GetTagBuf(arrBuffer, iTotalLen, iNum);
		            //if (bRet == 1)
		            //{
		            //	ShowInfo("DevOut");
		            //    return; //DevOut
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {  //Open
				if(RFID.instance.SWCom_OpenDevice((String)comboBox_2.getSelectedItem(),115200))
				{
					    ShowInfo("Success\r\n");
					    byte[] arrBuffer = new byte[48];
					    byte addr = (byte)0xff;
					    if(RFID.instance.SWCom_GetDeviceSystemInfo(addr, arrBuffer))  //Get DeviceInfo
					    {
				            String str = "",str1="";
							...
							timer.start();
							RFID.instance.SWCom_ClearTagBuf();
					    }
		...
		btnClose.addActionListener(new ActionListener() {  //Close
			public void actionPerformed(ActionEvent arg0) {
				timer.stop();
				RFID.instance.SWCom_CloseDevice();
				btnNewButton.setEnabled(true);
				btnClose.setEnabled(false);
			}
		});
		...
		btnRead.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            if (RFID.instance.SWCom_ReadDeviceOneParam((byte)0xFF, bParamAddr, bValue) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnSet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	            ...
	            if (RFID.instance.SWCom_SetDeviceOneParam((byte)0xFF, bParamAddr, bValue[0]) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnRead_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            if (RFID.instance.SWCom_ReadFreq((byte)0xFF, pFreq) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnSet_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            if (RFID.instance.SWCom_SetFreq((byte)0xFF, pFreq) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnRead_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	            if (RFID.instance.SWCom_StartRead((byte)0xFF) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
		...
		btnSet_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            if (RFID.instance.SWCom_StopRead((byte)0xFF) == false)
	            {
	            	ShowInfo("Faild");
	                return;
	            }
